  ...
  return (
    <div className="min-h-screen pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto animate-fade-in">
      ...
      <div className="prose prose-lg dark:prose-invert hover:prose-a:text-blue-600">
        <p>
          At MindNote, accessible from https://mindnote.com, one of our main priorities is the privacy of our visitors. 
          This Privacy Policy document contains types of information that is collected and recorded by MindNote and how we use it.
        </p>
        ...
        <h3>Log Files</h3>
        <p>
          MindNote follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies 
        ...
        <p>
          Like any other website, MindNote uses 'cookies'. These cookies are used to store information including visitors' preferences, 
        ...
        <p>
          MindNote's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective 
        ...
        <p>
          ...
          participate in, and/or monitor and guide their online activity. MindNote does not knowingly collect any Personal Identifiable 
