  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      if (lowerInput.includes('hello') || lowerInput.includes('hi')) {
        ...
        botResponseText = "I'm the MindNote AI assistant, designed to help you find content and answer basic questions.";
      }
      ...
      >
        ...
        <div className="bg-custom-black dark:bg-white p-4 flex justify-between items-center text-white dark:text-black">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-semibold text-sm">MindNote Assistant</h3>
